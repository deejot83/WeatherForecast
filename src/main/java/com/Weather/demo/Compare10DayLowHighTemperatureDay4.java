...
public class Compare10DayLowHighTemperatureDay4 {
	...
	public static void main(String[] args) {
		try
		{
			...
			//Get Date
			String strDay = driver.findElement(By.xpath("//table[@class='twc-table']//tr[4]/td[2]//span[@class='date-time']")).getText();
			String strDate = driver.findElement(By.xpath("//table[@class='twc-table']//tr[4]/td[2]//span[starts-with(@class,'day-detail')]")).getText();
			System.out.println("Today's Day is : " + strDay);
			System.out.println("Today's Date is : " + strDate);
			
			//Get weather description
			String desc = driver.findElement(By.xpath("//table[@class='twc-table']//tr[4]/td[3]")).getText();
			System.out.println("Today's weather is : " + desc);
			
			//Get Temperature
			String highLow = driver.findElement(By.xpath("//table[@class='twc-table']//tr[4]/td[4]")).getText();
			...
			//Get Precipitation
			String preceip = driver.findElement(By.xpath("//table[@class='twc-table']//tr[4]/td[5]")).getText();
			System.out.println("Today's Preceiptation is : " + preceip);
			
			//Get Wind
			String wind = driver.findElement(By.xpath("//table[@class='twc-table']//tr[4]/td[6]")).getText();
			System.out.println("Today's Wind is : " + wind);
			
			//Get Humidity
			String humidity = driver.findElement(By.xpath("//table[@class='twc-table']//tr[4]/td[7]")).getText();
